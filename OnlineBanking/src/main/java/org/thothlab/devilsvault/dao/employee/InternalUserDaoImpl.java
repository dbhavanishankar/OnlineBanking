...
public class InternalUserDaoImpl implements InternalUserDao {
    ...
    {
        String query = "INSERT INTO internal_user ( id , name , designation , address , city , state , country ,pincode, phone , email , date_of_birth , ssn ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
        Connection con = null;
        ...
        try{
            ...
            ps.setString(6, "");
            ps.setString(7, "");
            ps.setString(8, "532312");
            ps.setLong(9, userdetails.getPhone().longValue());
            ps.setString(10, userdetails.getEmail());
            ps.setString(11, userdetails.getDate_of_birth());
            ps.setString(12, userdetails.getSsn());
