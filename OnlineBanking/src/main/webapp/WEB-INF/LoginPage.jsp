...
<body>
	<header class="cd-main-header">
		...
		<a href="/CSE545-SS" style="padding-left: 20px"><img src="<c:url value="/resources/img/Symbol1.png"/>"
						 style="vertical-align:center;"
						 width="35px" height="55px" alt="Sparky"></a>
		<a href="/CSE545-SS"><img class="text-logo" src="<c:url value="/resources/img/IndianBank.png"/>"
													style="padding: 7px 0 7px 0"
													width="200px" height="65px" alt="Indian Bank"></a>

	</header> <!-- .cd-main-header -->
	<main class="cd-main-content">
		<div class="content-wrapper" id="login-container" align="center" style="padding-right: 100px">
			<div class="col-md-12" id="login-page">
				...
				<form action="<c:url value='j_spring_security_check' />" method='POST'>
     				...
     				<div class="col-lg-12 form-margin no-padding">
      				<div class="g-recaptcha" data-sitekey="6LfkT3IUAAAAAJHUR5lNj5JSDgwnJaWTRkqSycUY"></div>
      				</div>
      				<div class="col-lg-12 form-margin no-padding">
