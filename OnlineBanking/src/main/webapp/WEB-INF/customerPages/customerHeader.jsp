		...
		<nav class="cd-side-nav is-fixed">
			...
			<li>
				...
				<li class="has-children">
					...
					<ul>
						<li><a href="/controller/customer/CheckingAccount?checkingPicker='last month'">Checking</a></li>
						<li><a href="/controller/customer/SavingsAccount?savingsPicker='last month'">Savings</a></li>
				...
				<li><a href="/controller/customer/addMoneyOption">Add Money</a></li>
				<li><a href="/controller/customer/withdrawMoneyOption">Withdraw Money</a></li>
			</ul>
		</nav>